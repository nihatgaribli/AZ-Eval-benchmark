...
**1 qaçış qapıdan keçmir:**

| Qaçış | Dil | Bərpa oluna bilən səhv | Səhv sayı |
|---|---|---|---|
| `GiorgiGE/Kolkha-Mini-Georgian` | en | **42.4%** | 959 |
...
|---|---|---|---|
| `GiorgiGE/Kolkha-Mini-Georgian` | en | 42.4% | 959 |
| `microsoft/Phi-3.5-mini-instruct` | en | 16.4% | 531 |
| `openai:qwen/qwen3-235b-a22b-2507` | en | 16.0% | 362 |
| `issai/Qolda-AVL-5B (zeroshot)` | en | 15.5% | 586 |
| `Qwen/Qwen3-VL-4B-Thinking (zeroshot)` | en | 14.8% | 923 |
| `ytu-ce-cosmos/Turkish-Llama-8b-v0.1` | en | 14.4% | 557 |
| `INSAIT-Institute/MamayLM-Gemma-3-4B-IT-v1.0` | az | 13.7% | 868 |
| `issai/Qolda-AVL-5B` | az | 13.7% | 950 |
| `issai/Qolda-AVL-5B (script)` | az | 13.7% | 944 |
| `issai/Qolda-AVL-5B (plain)` | az | 13.3% | 955 |
