...
|---|---|---|---|---|---|
| `CohereLabs/aya-expanse-8b` | 40.3% | 6.8% | 33.5pp | [27.5, 39.4] | 0.0001 |
...
\* İngilis balı 5%-dən aşağı: `ai-forever/mGPT`, `bigscience/bloomz-1b7`, `stabilityai/stablelm-2-1_6b-chat`, `thelamapi/next-1b`, `utter-project/EuroLLM-1.7B-Instruct` tapşırığı ingiliscə də bacarmır. Onların sıfıra yaxın fərqi 'uçurum yoxdur' demək DEYİL: itirəcək balları yoxdur.
...
| `CohereLabs/aya-expanse-8b` | AZ | 6.8% | 5.3% | 15.8% |
| `HuggingFaceTB/SmolLM2-1.7B-Instruct` | EN | 7.2% | 17.9% | 35.9% |
...
| `issai/Qwen3.5-4B-Base-Kazakh` | EN | 57.2% | 24.8% | 59.0% |
...
| `openai:qwen/qwen3-235b-a22b-2507` | AZ | 78.0% | 22.0% | 48.3% |
